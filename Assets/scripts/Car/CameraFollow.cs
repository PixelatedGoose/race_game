...
public class CameraFollow : MonoBehaviour
{
    ...
    void FollowTarget()
    {
        HandleMovement();
        HandleRotation();
        Cam.fieldOfView = Mathf.Lerp(Cam.fieldOfView, Mathf.Lerp(normalFOV, ZoomFOV, Mathf.Clamp01(carController.CarRb.linearVelocity.magnitude / carController.MpsMaxSpeed)), Time.deltaTime * moveSmoothness);
    }
