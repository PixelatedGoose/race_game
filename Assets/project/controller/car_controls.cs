...
//     version 1.11.2
//     from Assets/project/controller/car_controls.inputactions
//
...
public partial class @Car_controls: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_CarControls_Movefoward = m_CarControls.FindAction("Move foward", throwIfNotFound: true);
        ...
        m_CarControls_controllerturn = m_CarControls.FindAction("controller turn", throwIfNotFound: true);
        m_CarControls_movebackward = m_CarControls.FindAction("move backward", throwIfNotFound: true);
        m_CarControls_turnleft = m_CarControls.FindAction("turn left", throwIfNotFound: true);
        m_CarControls_turnright = m_CarControls.FindAction("turn right", throwIfNotFound: true);
    ...
    ~@Car_controls()
    {
        UnityEngine.Debug.Assert(!m_CarControls.enabled, "This will cause a leak and performance issues, Car_controls.CarControls.Disable() has not been called.");
    }
    ...
    {
        private @Car_controls m_Wrapper;
        public CarControlsActions(@Car_controls wrapper) { m_Wrapper = wrapper; }
